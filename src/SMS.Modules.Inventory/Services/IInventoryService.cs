...
public interface IInventoryService
{
    ...
    // PV-006 — full-text search + admin-triggered full search-index rebuild.
    ...
    Task<CreateVariantResult?> CreateVariantAsync(int productId, CreateProductVariantRequest req, int userId);
    Task<bool> UpdateVariantAsync(Guid variantUuid, CreateProductVariantRequest req);
    Task<VariantDeleteResult> DeleteVariantAsync(Guid variantUuid);
    ...
    Task<bool> SetVariantAttributeValuesAsync(Guid variantUuid, SetVariantAttributeValuesRequest req);
}
