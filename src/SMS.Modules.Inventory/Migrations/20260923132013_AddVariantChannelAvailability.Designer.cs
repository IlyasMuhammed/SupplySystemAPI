...
namespace SMS.Modules.Inventory.Migrations
{
    ...
    [Migration("20260923132013_AddVariantChannelAvailability")]
    partial class AddVariantChannelAvailability
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMS.Modules.Inventory.Domain.ProductVariant", b =>
                {
                    ...
                    b.Property<bool>("IsAvailableForMirMiv")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsAvailableForPos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsAvailableForProduction")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsAvailableForRetail")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
