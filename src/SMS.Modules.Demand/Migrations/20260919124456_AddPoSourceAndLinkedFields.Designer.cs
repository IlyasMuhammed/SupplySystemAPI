...
namespace SMS.Modules.Demand.Migrations
{
    ...
    [Migration("20260919124456_AddPoSourceAndLinkedFields")]
    partial class AddPoSourceAndLinkedFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMS.Modules.Demand.Domain.PurchaseOrder", b =>
                {
                    ...
                    b.Property<decimal?>("AutoGeneratedPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("AutoGeneratedQty")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<int?>("LinkedSoId")
                        .HasColumnType("int");

                    b.Property<int?>("LinkedSoLineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LinkedSoId", "LinkedSoLineId");
            ...
            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrder", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "SoNumber")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "Status", "OrderDate");

                    b.ToTable("sale_orders", "demand");
                });
            ...
            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderConfig", b =>
                {
                    ...
                    b.Property<bool>("AutoPoEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<string>("DefaultFulfillmentMode")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<bool>("DropShipEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("EmailIntimationEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<string>("IntimationCcEmails")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<bool>("PartialFulfillmentAllowed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<int>("ReservationTtlHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(72);

                    b.Property<bool>("SelfPickupEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShipmentRequiredDefault")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<string>("SupplierSelectionMode")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("sale_order_config", "demand");
                });
            ...
            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderConfigAudit", b =>
                {
                    ...
                    b.Property<int>("SaleOrderConfigId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SaleOrderConfigId");

                    b.ToTable("sale_order_config_audit", "demand");
                });

            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderIntimation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("sale_order_intimations", "demand");
                });

            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderConfigAudit", b =>
                {
                    b.HasOne("SMS.Modules.Demand.Domain.SaleOrderConfig", "SaleOrderConfig")
                        ...
                        .HasForeignKey("SaleOrderConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SaleOrderConfig");
                });

            modelBuilder.Entity("SMS.Modules.Demand.Domain.SaleOrderIntimation", b =>
                {
                    b.HasOne("SMS.Modules.Demand.Domain.SaleOrder", "SaleOrder")
                        .WithMany()
